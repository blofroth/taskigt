...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_25bdd4607590c3694b8ab00316710999f3e3df6b": function($0, $1) {
            ...
            "__extjs_55930e70138d1eac196bf34081691354e06aa248": function($0, $1) {
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'taskigt'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'taskigt':", error );
                throw error;
            });
    } else {
